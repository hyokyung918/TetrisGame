...
public class PlayManager {
    ...
    public void update() {
        ...
        if (!currentMino.active) {
            ...
            if (currentMino.b[0].x == MINO_START_X && currentMino.b[0].y == MINO_START_Y) {
                // this means the currentMino immediately collided a block and shouldn't move at all
            ...
            // when a mino becomes inactive, check it line(s) can be deleted
            checkDelete();
        } else {
            currentMino.update();
        }
            ...
            if (x == right_x) {
                ...
                if (blockCount == 12) {
                    ...
                    for (int i=staticBlocks.size()-1; i>-1; i--) {
                        //remove all the blocks in the current y lines;
                    ...
                    // a line hase been deleted so need to slide down blocks that are above it
                    for (int i=0; i<staticBlocks.size(); i++) {
                        if (staticBlocks.get(i).y < y) {
    ...
    public void draw(Graphics2D g2) {
        ...
        g2.drawString("Hyokyeong's", x, y);
        g2.drawString("Tetris Game", x, y+60);
    }
}
